...
import { deleteRequest, getRequest, patchRequest, postRequest } from "../lib/api-client";
...
export function updateInventoryItemRequest(token, itemId, payload) {
  return patchRequest(`${API_PATHS.inventory.list}/${itemId}`, payload, {
    headers: {
      Authorization: `Bearer ${token}`
    }
  });
